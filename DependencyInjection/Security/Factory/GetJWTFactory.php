...
namespace Webonaute\SymfonyFirebaseAuthBundle\DependencyInjection\Security\Factory;
...
class GetJWTFactory implements SecurityFactoryInterface
{
    ...
    public function create(ContainerBuilder $container, $id, $config, $userProvider, $defaultEntryPoint)
    {
        ...
        $listener = $container
            ->setDefinition($listenerId, new DefinitionDecorator('webonaute_get_jwt.security.authentication.listener'))
            ->replaceArgument(2, $id)
